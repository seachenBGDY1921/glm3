...
llm_model_dict = {
    ...
    "fastchat-chatglm2-6b": {
        ...
        "local_model_path": None,
        "provides": "FastChatOpenAILLMChain",  # 使用fastchat api时，需保证"provides"为"FastChatOpenAILLMChain"
        "api_base_url": "http://127.0.0.1:8000/v1",  # "name"修改为fastchat服务中的"api_base_url"
        "api_key": "EMPTY"
    },

    "fastchat-chatglm3-6b": {
        "name": "chatglm3-6b",  # "name"修改为fastchat服务中的"model_name"
        "pretrained_model_name": "chatglm3-6b",
        "local_model_path": None,
        "provides": "FastChatOpenAILLMChain",  # 使用fastchat api时，需保证"provides"为"FastChatOpenAILLMChain"
        "api_base_url": "http://localhost:8000/v1",  # "name"修改为fastchat服务中的"api_base_url"
        "api_key": "EMPTY"
    ...
    "openai-chatgpt-3.5": {
        "name": "SparkDesk",
        "pretrained_model_name": "SparkDesk",
        "provides": "FastChatOpenAILLMChain",
        "local_model_path": None,
        "api_base_url": "http://localhost:3000/v1",
        "api_key": "sk-9aKmaj8vpFGB9OlRCdFaA7Dc352a40158d9578Bc29A0Ac6e"
    },
...
VECTOR_SEARCH_SCORE_THRESHOLD = 210
...
BING_SUBSCRIPTION_KEY = "0c94e67b69ff4784b60eba9bbebb85df"
